...
SIRfun_nb <- function(log.beta, log.gamma, log.mu, log.size, log.I0){
  ...
  ss <- try(as.data.frame(rk4(init_pop, time_vec3, mod4, parms22)))
...
# save(mfit_ls, file = "fits_mod0_nelder_s46.RData")
load("data/fits_mod0_nelder_s46.RData")
...
save(top_fits_nel_s46, file = "data/top_fits_nel_s46_2022.RData")
